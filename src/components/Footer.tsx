        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm opacity-80">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:owner@flowfrontglobal.com" className="hover:opacity-100">owner@flowfrontglobal.com</a>
              </li>
              <li className="flex items-start gap-2">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input placeholder="Your email" className="bg-background/10 border-footer-foreground/20 text-footer-foreground placeholder:text-footer-foreground/50" />
