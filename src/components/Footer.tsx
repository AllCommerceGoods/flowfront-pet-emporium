        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-80 font-semibold">
              <li><Link to="/shop" className="hover:opacity-100 hover:text-primary transition-all duration-200">Shop All</Link></li>
              <li><Link to="/about" className="hover:opacity-100 hover:text-primary transition-all duration-200">About Us</Link></li>
              <li><Link to="/contact" className="hover:opacity-100 hover:text-primary transition-all duration-200">Contact Us</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm opacity-80">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:owner@flowfrontglobal.com" className="hover:opacity-100 font-semibold hover:text-primary transition-all duration-200">owner@flowfrontglobal.com</a>
              </li>
              <li className="flex items-start gap-2">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <Button size="sm" className="bg-primary text-primary-foreground hover:bg-primary/90 flex-shrink-0 rounded-full font-bold px-5 shadow-lg shadow-primary/20">
                Subscribe
              </Button>
            </div>
          </div>
